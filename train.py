...
tf.flags.DEFINE_string("word2vec_model", "word_embed.txt", "word2vec pre-trained embeddings file (default: None)")
...
tf.flags.DEFINE_string("training_files", "corpus.txt", "training file (default: None)")  #for sentence semantic similarity use "train_snli.txt"
